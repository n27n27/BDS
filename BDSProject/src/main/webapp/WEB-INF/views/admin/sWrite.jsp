	...
	<div id=wrap>
		<div id=header>
	 	...
	 	<div id="middle">
			...
			<form action="../guest/sWriteOk" method="post"><!--  oninput='sContent.setCustomValidity(sContent.value != upw.value ? "비밀번호가 일치하지 않습니다" : "")'-->
				<input type="hidden" name="usrid" value=<sec:authentication property="name"/>>
				<table>
					<tr>
						<td> 제목 </td>
						<td><input type="text" name="sTitle" size="50" required></td>
					</tr>
					<tr>
						<td> 내용 </td>
						<td></td>
					...
					<tr>
						<td colspan="2"> 
							<textarea id="sContent" name="sContent" ></textarea>
	                        <script>
							 var ckeditor_config = {
							   height : 500,
					...
					<tr>
						<td colspan="2">
							<input type='submit' class="btn btn-dark" value="입력"> &nbsp;&nbsp;
